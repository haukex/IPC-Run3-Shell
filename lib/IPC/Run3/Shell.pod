...
This document describes version 0.52 of IPC::Run3::Shell.
...
(optional/optionally fatal) L<warning|/Warnings>,
...
for several reasons: it handles all three STDOUT, STDERR and STDIN;
