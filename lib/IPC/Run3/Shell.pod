...
This document describes version 0.53 of IPC::Run3::Shell.
...
The command and its argument list should only consist of plain scalars
and L<option hashes|/Options>, but not references, objects, or C<undef>,
...
This module changes C<undef> to C<""> (this behavior was added in v0.51).
References are currently passed through to L<IPC::Run3|IPC::Run3>,
which may cause unintended behavior, and this behavior may change in the future.
